...
SOURCE_FILES :=  main.c src/usart.c src/sram_test.c src/sram.c src/joystick.c src/oled.c src/fonts.c src/hsm.c src/spi.c src/mcp2515.c src/interrupt.c src/can.c
...
CC := avr-gcc
CFLAGS := -O -std=c11 -mmcu=$(TARGET_CPU) -Iinclude -ggdb
